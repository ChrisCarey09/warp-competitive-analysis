    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <Link href="/elevator-pitches" className="group">
          <div className="bg-warp-bg-primary border border-warp-border rounded-lg p-6 hover:bg-warp-bg-secondary transition-all duration-200 shadow-sm">
            <MessageSquare className="h-12 w-12 text-warp-accent mb-4" />
        ...
        <Link href="/technical-differentiators" className="group">
          <div className="bg-warp-bg-primary border border-warp-border rounded-lg p-6 hover:bg-warp-bg-secondary transition-all duration-200 shadow-sm">
            <Zap className="h-12 w-12 text-warp-accent mb-4" />
        ...
        <Link href="/battle-cards" className="group">
          <div className="bg-warp-bg-primary border border-warp-border rounded-lg p-6 hover:bg-warp-bg-secondary transition-all duration-200 shadow-sm">
            <Shield className="h-12 w-12 text-warp-accent mb-4" />
      ...
      <div className="bg-warp-bg-primary border border-warp-border rounded-lg p-8 shadow-sm">
